...
%             obj.S56_1 = zeros(6,1);
% 
%             obj.S12_1(1:3) = rotz(-90) * ([0,0,0]'-obj.A1);
%             obj.S23_1(1:3) = obj.S12_1(1:3);
%             obj.S34_1(1:3) = cross((obj.A2-obj.A3), obj.S23_1(1:3)); 
%             obj.S34_1(1:3) = obj.S34_1(1:3);
%             obj.S45_1(1:3) = obj.S23_1(1:3);
%             obj.S56_1(1:3) = obj.S34_1(1:3);
% 
%             obj.S12_1(4:6) = cross(obj.A1, obj.S12_1(1:3));
%             obj.S23_1(4:6) = cross(obj.A2, obj.S23_1(1:3));
%             obj.S34_1(4:6) = cross(obj.A2, obj.S34_1(1:3));
%             obj.S45_1(4:6) = cross(obj.A3, obj.S45_1(1:3));
%             obj.S56_1(4:6) = cross(obj.A3, obj.S56_1(1:3));
% 
%             obj.S01_1 = obj.S12_1;
% 
%             % Arm B:
...
%             obj.S56_2 = zeros(6,1);
% 
%             obj.S12_2(1:3) = rotz(-90) * ([0,0,0]'-obj.B1);
%             obj.S23_2(1:3) = obj.S12_2(1:3);
%             obj.S34_2(1:3) = cross((obj.B2-obj.B3), obj.S23_2(1:3)); 
%             obj.S34_2(1:3) = obj.S34_2(1:3);
%             obj.S45_2(1:3) = obj.S23_2(1:3);
%             obj.S56_2(1:3) = obj.S34_2(1:3);
% 
%             obj.S12_2(4:6) = cross(obj.B1, obj.S12_2(1:3));
%             obj.S23_2(4:6) = cross(obj.B2, obj.S23_2(1:3));
%             obj.S34_2(4:6) = cross(obj.B2, obj.S34_2(1:3));
%             obj.S45_2(4:6) = cross(obj.B3, obj.S45_2(1:3));
%             obj.S56_2(4:6) = cross(obj.B3, obj.S56_2(1:3));
% 
%             obj.S01_2 = obj.S12_2;
% 
%             % Arm C:
...
%             obj.S56_3 = zeros(6,1);
% 
%             obj.S12_3(1:3) = rotz(-90) * ([0,0,0]'-obj.C1);
%             obj.S23_3(1:3) = obj.S12_3(1:3);
%             obj.S34_3(1:3) = cross((obj.C2-obj.C3), obj.S23_3(1:3)); 
%             obj.S34_3(1:3) = obj.S34_3(1:3);
%             obj.S45_3(1:3) = obj.S23_3(1:3);
%             obj.S56_3(1:3) = obj.S34_3(1:3);
% 
%             obj.S12_3(4:6) = cross(obj.C1, obj.S12_3(1:3));
%             obj.S23_3(4:6) = cross(obj.C2, obj.S23_3(1:3));
%             obj.S34_3(4:6) = cross(obj.C2, obj.S34_3(1:3));
...
%             % Arm A
%             obj.Sl1 = zeros(6,1);
%             obj.Sl1(1:3) = (obj.A3-obj.A2);% / norm(A3-A2);
%             obj.Sl1(4:6) = cross(obj.A3, obj.Sl1(1:3));
% 
%             % Arm B
%             obj.Sl2 = zeros(6,1);
%             obj.Sl2(1:3) = (obj.B3-obj.B2);% / norm(B3-B2);
%             obj.Sl2(4:6) = cross(obj.B3, obj.Sl2(1:3));
% 
%             % Arm C
%             obj.Sl3 = zeros(6,1);
%             obj.Sl3(1:3) = (obj.C3-obj.C2);% / norm(B3-B2);
%             obj.Sl3(4:6) = cross(obj.C3, obj.Sl3(1:3));
% 
%             obj.J_A = [obj.Sl1(1:3), obj.Sl2(1:3), obj.Sl3(1:3)]';
%             BB1 = kleinForm(obj.S12_1,obj.Sl1);
%             BB2 = kleinForm(obj.S12_2,obj.Sl2);
%             BB3 = kleinForm(obj.S12_3,obj.Sl3);
%             obj.J_B = diag([BB1, BB2, BB3]);
% 
%             % Screws of upper arms:
%             obj.SL1 = zeros(6,1);
%             obj.SL1(1:3) = (obj.A2-obj.A1);
%             obj.SL1(4:6) = cross(obj.SL1(1:3),obj.A2);
% 
%             obj.SL2 = zeros(6,1);
%             obj.SL2(1:3) = (obj.B2-obj.B1);
%             obj.SL2(4:6) = cross(obj.SL2(1:3),obj.B2);
% 
%             obj.SL3 = zeros(6,1);
%             obj.SL3(1:3) = (obj.C2-obj.C1);
%             obj.SL3(4:6) = cross(obj.SL3(1:3),obj.C2);
%                     
%             obj.J_A = [obj.S12_1(1:3), obj.S12_2(1:3), obj.S12_3(1:3)]';
% 
%             BB1 = kleinForm(obj.S12_1,obj.Sl1);
%             BB2 = kleinForm(obj.S12_2,obj.Sl2);
%             BB3 = kleinForm(obj.S12_3,obj.Sl3);
...
%             obj.J_B = diag([BB1, BB2, BB3]);
%             
% 			obj.J = obj.J_B\obj.J_A;
% 			obj.Jinv = obj.J_A\obj.J_B;
% 			
% 			S.S01_1 = obj.S01_1;
% 			S.S12_1 = obj.S12_1;
% 			S.S23_1 = obj.S23_1;
...
%         end
        ...
        function S = calculateScrews(obj, varargin)
            ...
            obj.S12_1(1:3) = rotz(90)' * ((obj.A1)/norm(obj.A1));
            obj.S23_1(1:3) = obj.S12_1(1:3);
            ...
            obj.S12_2(1:3) = rotz(90)' * ((obj.A2)/norm(obj.A2));
            obj.S23_2(1:3) = obj.S12_2(1:3);
            ...
            obj.S12_3(1:3) = rotz(90)' * ((obj.A3)/norm(obj.A3));
            obj.S23_3(1:3) = obj.S12_3(1:3);
            ...
            obj.SL3 = zeros(6,1);
            obj.SL3(1:3) = (obj.B3-obj.A2)/(norm(obj.B3-obj.A3));
        ...
        function [eigVectors, eigValues] = getVelocityEigens(obj, varargin)
            ...
            eigVecs = zeros(3,3,size(M,3)); %#ok<PROPLC>
            eigValues = zeros(3,3,size(M,3));
            
            for i = 1:size(M,3)
                [eigVecs(:,:,i),eigValues(:,:,i)] = eig(M(:,:,i)); %#ok<PROPLC>
            end
        ...
        function [mu1, mu2, mu3] = getManipulabilityMeasures(obj, varargin)
            ...
            if isempty(obj.eigValues)
                obj.getVelocityEigens();
            else
                if size(obj.eigValues,3) ~= size(obj.theta,1)
                    obj.getVelocityEigens();
                end
            end
           
            mu1 = zeros(size(obj.eigValues,3),1);
            mu2 = zeros(size(obj.eigValues,3),1);
            mu3 = zeros(size(obj.eigValues,3),1);
            for i = 1:size(obj.eigValues,3)
                ...
                mu3(i) = prod(eigValues, 'all'); %#ok<PROPLC>
            end
        end
        
        function Pts = realGeometry(obj)
        
            Pts.B1L = obj.B1 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            Pts.B1R = obj.B1 - norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            Pts.B2L = obj.B2 + norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
            Pts.B2R = obj.B2 - norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
            Pts.B3L = obj.B3 + norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
            Pts.B3R = obj.B3 - norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];

            Pts.C1L = obj.C1 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            Pts.C1R = obj.C1 - norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            Pts.C2L = obj.C2 + norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
            Pts.C2R = obj.C2 - norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
            Pts.C3L = obj.C3 + norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
            Pts.C3R = obj.C3 - norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
        ...
        function plotHandles = plotMechanism(obj, varargin)
            ...
            if any(strcmp('real', varargin))
                ...
                plotHandles.BaseTriangle = fill3([obj.A1(1), obj.A2(1), obj.A3(1)], [obj.A1(2), obj.A2(2), obj.A3(2)], [obj.A1(3), obj.A2(3), obj.A3(3)], C);
        ...
        function CoM = CoMs(obj, varargin)
            ...
            if strcmp('real', varargin)
                obj.B1L = obj.B1 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
                obj.B1R = obj.B1 - norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
                obj.B2L = obj.B2 + norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
                obj.B2R = obj.B2 - norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
                obj.B3L = obj.B3 + norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
                obj.B3R = obj.B3 - norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];

                obj.C1L = obj.C1 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
                obj.C1R = obj.C1 - norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
                obj.C2L = obj.C2 + norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
                obj.C2R = obj.C2 - norm(obj.A2)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0];
                obj.C3L = obj.C3 + norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
                obj.C3R = obj.C3 - norm(obj.A3)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0];
...
%             rA = obj.A1 + (obj.A2-obj.A1); 
            ...
            % Arm B
            TB = rotz(-obj.alpha12)*rotx(90+obj.theta(2));
%             rB = obj.B1 + (obj.B2-obj.B1);
            ...
            % Arm C
            TC = rotz(-obj.alpha13)*rotx(90+obj.theta(3));
...
%             rC = obj.C2 + (obj.C3-obj.C2);
        ...
        function [RLA, RLB, RLC, RlA, RlB, RlC] = arms_rotationalMatrices(obj)
            ...
            RLA = rotx(obj.theta(1)+90);
            RLB = rotz(-obj.alpha12)*rotx(obj.theta(2)+90);
            RLC = rotz(-obj.alpha13)*rotx(obj.theta(3)+90);
...
%             phi_S12CSlC = phi_S12CSlC;%+90;
            ...
            A2L = obj.A2 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            B2L = obj.B2 + norm(obj.B1)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0]; %#ok<PROPLC>
            C2L = obj.C2 + norm(obj.C1)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0]; %#ok<PROPLC>
            
            A3L = obj.A3 + norm(obj.A1)/10 * rotz(90)*[sin(0); cos(0); 0];
            B3L = obj.B3 + norm(obj.B1)/10 * rotz(90)*[sin(obj.alpha12); cos(obj.alpha12); 0]; %#ok<PROPLC>
            C3L = obj.C3 + norm(obj.C1)/10 * rotz(90)*[sin(obj.alpha13); cos(obj.alpha13); 0]; %#ok<PROPLC>
...
%             e = 1e-8;
            ...
            if c1(3) == c2(3) && c2(3) == c3(3)
                [UpperIntersectionPoint, LowerIntersectionPoint] = obj.SimplifiedThreeSpheresIntersectionAlgorithm(c1, c2, c3, r1, r2, r3);
            else
...
%             z = nan(length(a),2);
        ...
        function [ws_cube, PtsMapped] = plotWS(obj, ws_cube, theta, resolution, varargin)
        ...
        function plotWSCube(obj, ws_cube, resolution, varargin)
            resolution = resolution/2;
            hold on;
            grid on;
...
%                    plotcube(resolution*[1 1 1], obj.B1', obj.bit(5).Opacity, obj.bit(5).Color);
        ...
        function cube = CubeAboutPoints(obj, pts,varargin)
            ...
            if any(strcmpi(varargin, 'ws_cube'))
                ...
                cube = obj.myPlotCube(pts, arg1, arg2, arg3, arg4);
            end
            cube.pts = pt;
        ...
        function cube = myPlotCube(~, pts, varargin)
...
%             end
            ...
            if any(strcmpi(varargin, "edgePlot"))
                ...
                edge1 = plot3([min_x min_x], [min_y max_y], [min_z min_z], 'r');
                edge2 = plot3([min_x max_x], [min_y min_y], [min_z min_z], 'r');
                edge3 = plot3([max_x max_x], [min_y max_y], [min_z min_z], 'r');
                edge4 = plot3([min_x max_x], [max_y max_y], [min_z min_z], 'r');

                edge5 = plot3([min_x min_x], [min_y max_y], [max_z max_z], 'r');
                edge6 = plot3([min_x max_x], [min_y min_y], [max_z max_z], 'r');
                edge7 = plot3([max_x max_x], [min_y max_y], [max_z max_z], 'r');
                edge8 = plot3([min_x max_x], [max_y max_y], [max_z max_z], 'r');

                edge9 = plot3([min_x min_x], [min_y min_y], [min_z max_z], 'r');
                edge10 = plot3([max_x max_x], [min_y min_y], [min_z max_z], 'r');
                edge11 = plot3([min_x min_x], [max_y max_y], [min_z max_z], 'r');
                edge12 = plot3([max_x max_x], [max_y max_y], [min_z max_z], 'r');
        ...
        function cube = prepareGridFromCube(~, cube, edgeResolution, varargin)
            ...
            cube.grid.xAxis.points = cube.xAxis.min:edgeResolution/range(cube.pts(:,1)):cube.xAxis.max;
            cube.grid.yAxis.points = cube.yAxis.min:edgeResolution/range(cube.pts(:,2)):cube.yAxis.max;
            cube.grid.zAxis.points = cube.zAxis.min:edgeResolution/range(cube.pts(:,3)):cube.zAxis.max;
        ...
        %     [z_minValue, z_closestIndex] = min(cube.grid.zAxis.points - Coordinate_point(3));
            ...
            gridValuesMapped.x.coords = x_minValue;
            gridValuesMapped.y.coords = y_minValue;
            gridValuesMapped.z.coords = z_minValue;
        ...
        function ws_cube = getCubeAboutRobot(obj, resolution, varargin)
            ...
            ws_cube = obj.CubeAboutPoints(pts, arg1, arg2, arg3, arg4);
